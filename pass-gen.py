...
try:
	...
	print("\033[1;38;2;255;0;0mDon't be silly, it has to be an integer (number)\033[0m 🤦")
	sys.exit(1)
except IndexError:
	print("\033[1;38;2;255;0;0mDon't be silly, input something, at least!\033[0m 🤦")
	sys.exit(1)
except ValueError:
	print("\033[1;38;2;255;0;0mDon't be silly, it has to be an integer (number)\033[0m 🤦")
	sys.exit(1)
...
if password >= 1:
	if (password <= 50) & (password >= 6):
	    ...
	    print(''.join(random.choices(together,k=password_length)))
	if password > 50:
		print("\033[1;38;2;255;0;0mPlease provide a reasonable password length (i.e. 6-50)\033[0m 🤦")
	if password < 6:
